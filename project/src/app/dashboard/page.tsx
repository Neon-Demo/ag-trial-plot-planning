    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-background p-6 rounded-lg shadow animate-pulse">
      ...
      <div className="bg-background rounded-lg shadow">
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link 
            href="/settings"
            className="bg-background-secondary hover:bg-primary-light p-4 rounded-lg flex flex-col items-center justify-center transition text-center"
          >
