...
export default function Home() {
  return (
    <div className="min-h-screen bg-light-green-400">
      {/* Header */}
      <header className="bg-light-green-500 shadow-md">
      ...
      {/* Hero section */}
      <div className="bg-gradient-to-b from-light-green-400 to-white py-16 md:py-24">
      ...
      {/* Features section */}
      <section id="features" className="py-16 md:py-24 bg-light-green-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* CTA section */}
      <section className="bg-light-green-500 py-16">
      ...
      {/* Footer */}
      <footer className="bg-light-green-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-light-green-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
